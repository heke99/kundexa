...
- Livecredentials, kontrakt och verifierade Rinkel-samtal/webhookar samt callbacks för e-post, data och NIX: `BLOCKED EXTERNALLY`.
...
- Slutverifiering i detta arkiv körs i Node 24.14.0/npm 11.9.0 trots att Node 22.x/npm 10.9.2 är avsedd runtime.
