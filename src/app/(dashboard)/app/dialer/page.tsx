...
export default async function DialerPage({ searchParams }: { searchParams: Promise<{ customer?: string; callback?: string; error?: string }> }) {
  ...
  return <>
    ...
    <div className="dialer-grid">
      <div className="phone-panel"><RinkelDialer customers={customers ?? []} initialCustomer={params.customer} callbackActivityId={params.callback} callerIdOptions={(callerIdData ?? []) as Array<{ allocationId: string; number: string; displayName: string | null }>} /></div>
      <div className="grid">
