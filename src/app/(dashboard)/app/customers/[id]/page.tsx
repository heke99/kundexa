      ...
      <div className="grid">
        ...
        <Card>
          ...
          <CardContent>
            ...
            {mayWrite ? <details open={Boolean(query.error)}><summary className="button button-secondary button-sm">Redigera kunduppgifter</summary><form action={updateCustomerDetails} className="form-grid" style={{ marginTop: 12 }}>
