...
Detta är ett körbart Kundexa-projekt med Next.js, Supabase, 23 ordnade migrationer, sex Edge Function-workers, versionerat API, tester och produktionsbuild.
