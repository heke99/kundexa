...
6. Samtalet reserveras atomiskt i Kundexa mot företagets egna nummer, och webbläsarens webbtelefon ringer upp. Inga providerhemligheter går till webbläsaren; klienten får en kortlivad token som servern signerat.
...
- välja ett av företagets aktiva nummer som caller-ID och aktivera inspelning enligt tenantens retentionpolicy;
...
Den fristående dialern använder `complete_manual_call_work_v2` och har samma krav på provideravslutat samtal, utfall, anteckning, ny återkomst och kontaktspärr.
...
Kodflödet är klart, men skarp telefoni kräver Kundexas leverantörskonto, företagets egna nummer upplagda och valda, en registrerad callback-adress och stagingprov med riktiga samtal. Tenants ansluter inte egna telefonikonton. E-post, NIX och valda dataleverantörer behöver egna liveprov, och inspelning/transkribering kräver juridiskt beslut och tenantpolicy. Prediktiv dialer, medlyssning och coachning ingår avsiktligt inte i denna sekventiella power-dialer-version.
